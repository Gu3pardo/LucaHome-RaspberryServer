...
#define MONEY_METER_DATA_BANK_INDEX 5
#define MONEY_METER_DATA_PLAN_INDEX 6
#define MONEY_METER_DATA_AMOUNT_INDEX 7
#define MONEY_METER_DATA_UNIT_INDEX 8
#define MONEY_METER_DATA_DAY_INDEX 9
#define MONEY_METER_DATA_MONTH_INDEX 10
#define MONEY_METER_DATA_YEAR_INDEX 11
#define MONEY_METER_DATA_USER_INDEX 12
#define MONEY_METER_DATA_SIZE 13
