...
void AudioService::Initialize(std::string audioPath, std::string wakeUpSound, std::string alarmSound, int raspberry) {
...
std::string AudioService::PerformAction(std::string action, std::vector<std::string> data) {
	if (action == GET) {
		if (data[4] == "FILES") {
