...
string SuggestedShoppingItemService::PerformAction(vector<string> data)
{
	...
	else if (action == ADD)
	{
		if (data.size() == SUGGESTED_SHOPPING_ITEM_DATA_SIZE)
		{
			...
			actionAnswer << "{\"Category\":\"SuggestedShoppingItem\",\"Error\":125,\"Success\":false,\"Data\":\"" << error << "\"}\x00" << endl;
...
string SuggestedShoppingItemService::getJsonString()
{
	...
	stringstream out;
	out << "{\"Category\":\"SuggestedShoppingItem\",\"Action\":\"Get\",\"Success\":true,\"Data\":["
